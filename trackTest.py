...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str,
                        default='E:\coco2017\\video\\testrim.mp4', help='source')
    # parser.add_argument('--source', type=str,
    #                     default='E:\coco2017\\video\\test_game.mp4', help='source')
    parser.add_argument('--output', type=str, default='inference/output2',
